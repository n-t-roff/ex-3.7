 ...
 */
#define	EXRECOVER	LIBDIR "/ex" VERSION "recover"
#define	EXPRESERVE	LIBDIR "/ex" VERSION "preserve"
#ifndef VMUNIX
...
#define	VBSIZE		4096		/* Partial line max size in visual */
